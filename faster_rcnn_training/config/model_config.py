...
config = dict(
    ...
    img_dir=r"bddk-fasterrcnn-resnet-objectdetection/assignment_data_bdd/bdd100k_images_100k",       # Path to the images.
    label_dir=r"bddk-fasterrcnn-resnet-objectdetection/assignment_data_bdd/bdd100k_labels_release",  # Path to the labels.
