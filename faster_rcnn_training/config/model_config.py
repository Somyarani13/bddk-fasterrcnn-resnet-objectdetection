...
config = dict(
    ...
    img_dir=r"./assignment_data_bdd/bdd100k_images_100k",       # Path to the images.
    label_dir=r"./assignment_data_bdd/bdd100k_labels_release",  # Path to the labels.
    ...
    device='cuda'          # Device to run on: 'cuda' (GPU) or 'cpu'.
)
